...
nombre_imagen_oculta = "utiles2/interrogacion.png"
...
"""
cuadros = [
    [Cuadro(f"{directorio}/1.png"), Cuadro(f"{directorio}/1.png"),
     Cuadro(f"{directorio}/2.png"), Cuadro(f"{directorio}/2.png")],
    [Cuadro(f"{directorio}/3.png"), Cuadro(f"{directorio}/3.png"),
     Cuadro(f"{directorio}/4.png"), Cuadro(f"{directorio}/4.png")],
    [Cuadro(f"{directorio}/5.png"), Cuadro(f"{directorio}/5.png"),
     Cuadro(f"{directorio}/6.png"), Cuadro(f"{directorio}/6.png")],
    [Cuadro(f"{directorio}/7.png"), Cuadro(f"{directorio}/7.png"),
     Cuadro(f"{directorio}/8.png"), Cuadro(f"{directorio}/8.png")],
]
...
# Los sonidos
sonido_fondo = pygame.mixer.Sound("sonidos/musicgame.wav")
sonido_clic = pygame.mixer.Sound("sonidos/clic.wav")
sonido_exito = pygame.mixer.Sound("sonidos/win.wav")
sonido_fracaso = pygame.mixer.Sound("sonidos/error.wav")
...
icono=pygame.image.load("utiles2/icono.png")
